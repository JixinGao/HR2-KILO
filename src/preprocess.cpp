...
const int N_SCAN = 6;
const int Horizon_SCAN = 4000;
const float segmentTheta = 1.0472;
Eigen::Matrix<int8_t, Eigen::Dynamic, Eigen::Dynamic> rangeMat(N_SCAN, Horizon_SCAN);
Eigen::Matrix<int8_t, Eigen::Dynamic, Eigen::Dynamic> labelMat(N_SCAN, Horizon_SCAN);
Eigen::Matrix<int8_t, Eigen::Dynamic, Eigen::Dynamic> groundMat(N_SCAN, Horizon_SCAN);
